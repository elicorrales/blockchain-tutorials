...
#in the README of that repo, it refers to using the 1st one (above)
#or the "nvm-sh/nvm/" script

#I think either one should work.

OUTPUT:
lots of output, but it adds to your .bashrc:
...
DO:
nvm list-remote
OUTPUT: a long list of node versions. as of this date (2022-07-01) the
latest is v18.4.0, and the LTS is v16.15.1
